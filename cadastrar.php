...
<section class="w3ls-section contact" id="contact">
	<div class="container">
		<div class="w3ls-title">
			<h3 class="heading">Cadastro de <span>Eventos</span></h3>
</div>
		<div class="contact_wthreerow agileits-w3layouts">
		
			<div class="col-md-7 w3l_contact_form">
				<h4>Cadastro de Evento</h4>
				<form name="signup" enctype="multipart/form-data" method="post" action="salva_cadastro.php">
					<input type="text" name="nome" value="Nome" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Nome';}"
						required="">
					<br><br>
					<input type="date" name="data" value="data" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'data';}"
						required="">
					<br><br>
 ...
 <form action="deslogar.php">
        <button class="btn btn-primary">SAIR</button><br><br>
 </form>
